...
def MXResNet18(height = 224, width = 224, depth = 3, classes = 1000):
...
def MXResNet34(height = 224, width = 224, depth = 3, classes = 1000):
    assert height >= 32 and width >= 32, "[ERROR] minimum supported image dimensions: 32x32"
...
def MXResNet50(height = 224, width = 224, depth = 3, classes = 1000):
    assert height >= 32 and width >= 32, "[ERROR] minimum supported image dimensions: 32x32"
...
def MXResNet101(height = 224, width = 224, depth = 3, classes = 1000):
    assert height >= 32 and width >= 32, "[ERROR] minimum supported image dimensions: 32x32"
...
def MXResNet152(height = 224, width = 224, depth = 3, classes = 1000):
    assert height >= 32 and width >= 32, "[ERROR] minimum supported image dimensions: 32x32"
