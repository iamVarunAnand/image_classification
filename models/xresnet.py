...
def XResNet18(height = 224, width = 224, depth = 3, classes = 1000):
...
def XResNet34(height = 224, width = 224, depth = 3, classes = 1000):
    assert height >= 32 and width >= 32, "[ERROR] minimum supported image dimensions: 32x32"
...
def XResNet50(height = 224, width = 224, depth = 3, classes = 1000):
    assert height >= 32 and width >= 32, "[ERROR] minimum supported image dimensions: 32x32"
...
def XResNet101(height = 224, width = 224, depth = 3, classes = 1000):
    assert height >= 32 and width >= 32, "[ERROR] minimum supported image dimensions: 32x32"
...
def XResNet152(height = 224, width = 224, depth = 3, classes = 1000):
    assert height >= 32 and width >= 32, "[ERROR] minimum supported image dimensions: 32x32"
