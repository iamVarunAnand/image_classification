...
def SEMXResNet32(height = 32, width = 32, depth = 3, classes = 10):
    return SEMXResNet.build(height, width, depth, classes,
                            stages = [5, 5, 5],
                            filters = [16, 16, 32, 64],
                            stem_type = "cifar",
...
def SEMXResNet44(height = 32, width = 32, depth = 3, classes = 10):
    return SEMXResNet.build(height, width, depth, classes,
                            stages = [7, 7, 7],
                            filters = [16, 16, 32, 64],
                            stem_type = "cifar",
...
def SEMXResNet56(height = 32, width = 32, depth = 3, classes = 10):
    return SEMXResNet.build(height, width, depth, classes,
                            stages = [9, 9, 9],
                            filters = [16, 16, 32, 64],
                            stem_type = "cifar",
